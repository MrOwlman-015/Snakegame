...
if (check_errors[1] > 0):
    ...
    print("Game Succcessfully initialized")
...
fps_cotroller = pygame.time.Clock()

square_size = 20

def init_var():
    global head_pos, snake_body, food_pos, food_spam, score, direction
    direction = "RIGHT"
    head_pos = [120,60]
    snake_body = [[120, 60]]
